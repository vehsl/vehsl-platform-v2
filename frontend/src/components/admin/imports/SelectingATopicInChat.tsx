...
import svgPaths from "./svg-4fib84c4j7";
...
function P2() {
  return (
    <div className="h-[22.938px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Urbanist:Regular',sans-serif] leading-[22.94px] left-0 not-italic text-[14.8px] text-white top-[-1.4px] tracking-[-0.074px] whitespace-nowrap">I need help with an order</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="bg-[#0071e3] h-[50.938px] relative rounded-bl-[22px] rounded-br-[6px] rounded-tl-[22px] rounded-tr-[22px] shadow-[0px_2px_12px_0px_rgba(0,113,227,0.2)] shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pt-[14px] px-[20px] relative size-full">
        <P2 />
      </div>
    </div>
...
function P3() {
  return (
    <div className="h-[16.313px] relative shrink-0 w-full" data-name="p">
      <p className="-translate-x-full absolute font-['Urbanist:Regular',sans-serif] leading-[16.32px] left-[192.08px] not-italic text-[#c7c7cc] text-[10.88px] text-right top-[-0.4px] whitespace-nowrap">4:51 PM</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="h-[73.25px] relative shrink-0 w-[199.375px]" data-name="Container">
...
function Div2() {
  return (
    <div className="h-[73.25px] relative shrink-0 w-[199.375px]" data-name="div">
...
function MotionDiv2() {
  return (
    <div className="absolute content-stretch flex h-[73.25px] items-start justify-end left-[24px] top-[184.19px] w-[672px]" data-name="motion.div">
      <Div2 />
    </div>
  );
}
...
function P4() {
  return (
    <div className="h-[68.813px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Urbanist:Regular',sans-serif] leading-[22.94px] left-0 not-italic text-[#1d1d1f] text-[14.8px] top-[-1.4px] tracking-[-0.074px] w-[406px]">{`I'd be happy to help with your order! Could you share your order number? You can find it in My Orders or in your confirmation email. It starts with #VH-.`}</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="bg-white h-[96.813px] relative rounded-bl-[6px] rounded-br-[22px] rounded-tl-[22px] rounded-tr-[22px] shadow-[0px_1px_8px_0px_rgba(0,0,0,0.03)] shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pt-[14px] px-[20px] relative size-full">
        <P4 />
      </div>
    </div>
...
function P5() {
  return (
    <div className="h-[16.313px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Urbanist:Regular',sans-serif] leading-[16.32px] left-[8px] not-italic text-[#c7c7cc] text-[10.88px] top-[-0.4px] whitespace-nowrap">4:51 PM</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] h-[119.125px] items-start left-[42px] top-0 w-[462px]" data-name="Container">
      <Container8 />
      <P5 />
    </div>
  );
...
function Div3() {
  return (
    <div className="h-[119.125px] relative shrink-0 w-[504px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container6 />
        <Container7 />
      </div>
...
function MotionDiv3() {
  return (
    <div className="absolute content-stretch flex h-[119.125px] items-start left-[24px] top-[273.44px] w-[672px]" data-name="motion.div">
      <Div3 />
    </div>
  );
}
...
function Container9() {
  return <div className="absolute h-0 left-[24px] top-[408.56px] w-[672px]" data-name="Container" />;
}

function Container() {
  return (
    <div className="h-[432.563px] relative shrink-0 w-full" data-name="Container">
      <Span />
      <MotionDiv1 />
      <MotionDiv2 />
      <MotionDiv3 />
  ...
  return (
    <div className="flex-[1_0_0] h-[38.8px] min-h-px min-w-px relative" data-name="input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip py-[8px] relative rounded-[inherit] size-full">
        <p className="font-['Urbanist:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c7c7cc] text-[15.2px] tracking-[-0.152px] whitespace-nowrap">Type a message...</p>
      </div>
    </div>
  );
}
...
export default function SelectingATopicInChat() {
  return (
    <div className="bg-white relative size-full" data-name="selecting a topic in chat">
      <MotionDiv />
      <Div4 />
      <Div7 />
    </div>
