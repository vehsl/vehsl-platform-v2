...
import svgPaths from "./svg-8vwn0vdzk2";
const imgImage172 = "/figma/15fdd34daad1d5d51bb45936cca22cee6712c580.png";
import { imgGroup } from "./svg-kpm4y";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p1cfe2980} id="Vector" stroke="var(--stroke-0, #0171E3)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33" />
      ...
      <div className="absolute inset-[-3.75%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.9 12.9">
          <g id="Group">
            ...
            <path d={svgPaths.p34054c90} id="Vector_2" stroke="var(--stroke-0, #0171E3)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="0.9" />
            <path clipRule="evenodd" d={svgPaths.p1cdea300} fill="var(--fill-0, #0171E3)" fillOpacity="0.6" fillRule="evenodd" id="Vector_3" />
          </g>
        </svg>
      </div>
    </div>
...
function Icon2() {
  return (
    <div className="h-[18px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      ...
      <div className="absolute inset-[69.57%_12.5%_12.51%_69.58%]" data-name="Vector">
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d={svgPaths.p6e97800} fill="var(--fill-0, #E17100)" id="Vector" />
        </g>
      </svg>
    </div>
  );
        ...
        <div className="h-[10.489px] relative shrink-0 w-[11px]" data-name="Vector">
          <div className="absolute inset-[-81.52%_-77.73%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28.0999 27.5886">
              <g filter="url(#filter0_d_49_1863)" id="Vector">
              ...
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="27.5886" id="filter0_d_49_1863" width="28.0999" x="1.19209e-07" y="1.19209e-07">
                  ...
                  <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_49_1863" />
                  <feBlend in="SourceGraphic" in2="effect1_dropShadow_49_1863" mode="normal" result="shape" />
                </filter>
              </defs>
            </svg>
          </div>
...
function Icon5() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d={svgPaths.p21e2f00} fill="var(--fill-0, #99ACBF)" id="Vector" stroke="var(--stroke-0, #99ACBF)" strokeOpacity="0.4" strokeWidth="0.5" />
  ...
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g clipPath="url(#clip0_49_1855)" id="Icon">
          <path d={svgPaths.p18777900} id="Vector" stroke="var(--stroke-0, #00BC7D)" strokeOpacity="0.7" strokeWidth="0.916667" />
          <path d={svgPaths.p2eae6400} id="Vector_2" stroke="var(--stroke-0, #00BC7D)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" strokeWidth="0.916667" />
        </g>
        <defs>
...
function Icon7() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d={svgPaths.p6e97800} fill="var(--fill-0, #009966)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Icon10() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d={svgPaths.p6e97800} fill="var(--fill-0, #FC6188)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Icon15() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d={svgPaths.p6e97800} fill="var(--fill-0, #0084D1)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Icon20() {
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g clipPath="url(#clip0_49_1833)" id="Icon">
          <path d={svgPaths.p18777900} id="Vector" stroke="var(--stroke-0, #FF637E)" strokeOpacity="0.7" strokeWidth="0.916667" />
          <path d={svgPaths.p2eae6400} id="Vector_2" stroke="var(--stroke-0, #FF637E)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" strokeWidth="0.916667" />
        </g>
        <defs>
...
function Container4() {
  return (
    <div className="absolute h-[1164px] left-0 top-0 w-[477px]" data-name="Container">
      <Container5 />
      <Container10 />
      <Container11 />
      <Paragraph1 />
...
function Container3() {
  return (
    <div className="absolute bg-gradient-to-b from-[rgba(237,242,247,0.2)] h-[953px] left-[-2px] to-[rgba(232,239,248,0.2)] top-[-2px] via-1/2 via-[rgba(240,244,250,0.2)] w-[477px]" data-name="Container">
      <Container4 />
      <div className="absolute content-stretch flex flex-col gap-[7px] h-[70px] items-center left-[452px] top-[336.6px] w-[8px]" data-name="Container">
        <Container80 />
        <Container81 />
        <Container82 />
        <Container83 />
...
function Container2() {
  return (
    <div className="absolute border-2 border-solid border-white h-[952px] left-0 overflow-clip rounded-[60px] top-0 w-[476px]" data-name="Container">
      <Container3 />
    </div>
  );
}
...
function Container() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[rgba(0,0,0,0)] h-[952px] left-[calc(50%-445px)] rounded-[60px] shadow-[0px_2px_16px_0px_rgba(0,0,0,0.25)] top-1/2 w-[476px]" data-name="Container">
      <Container1 />
      <Container2 />
    </div>
  );
...
function Frame() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center px-[5px] py-[22px] relative rounded-[100px] shrink-0 size-[56px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-[-0.5px] pointer-events-none rounded-[100.5px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)]" />
      <div className="flex flex-col font-['Urbanist:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18191a] text-[16px] text-center tracking-[-0.4px] whitespace-nowrap">
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex items-center left-[970px] p-[10px] top-[144.99px]">
      <Frame />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center justify-center left-[614px] px-[5px] py-[22px] rounded-[100px] size-[56px] top-[131.79px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-[-0.5px] pointer-events-none rounded-[100.5px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)]" />
      <div className="flex flex-col font-['Urbanist:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18191a] text-[16px] text-center tracking-[-0.4px] whitespace-nowrap">
        <p className="leading-[24px]">$55</p>
      </div>
...
function Frame5() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center justify-center left-[572px] px-[5px] py-[22px] rounded-[100px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)] size-[56px] top-[440.75px]">
      <div className="flex flex-col font-['Urbanist:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18191a] text-[16px] text-center tracking-[-0.4px] whitespace-nowrap">
...
function Frame6() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center justify-center left-[586px] px-[5px] py-[22px] rounded-[100px] size-[56px] top-[738px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-[-0.5px] pointer-events-none rounded-[100.5px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)]" />
      <div className="flex flex-col font-['Urbanist:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18191a] text-[16px] text-center tracking-[-0.4px] whitespace-nowrap">
...
function Frame1() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center justify-center left-[1036px] px-[5px] py-[22px] rounded-[100px] size-[56px] top-[244.32px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-[-0.5px] pointer-events-none rounded-[100.5px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)]" />
      <div className="flex flex-col font-['Urbanist:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18191a] text-[16px] text-center tracking-[-0.4px] whitespace-nowrap">
        <p className="leading-[24px]">$35</p>
      </div>
...
function Frame2() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center justify-center left-[1222px] px-[5px] py-[22px] rounded-[100px] size-[56px] top-[889px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-[-0.5px] pointer-events-none rounded-[100.5px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)]" />
      <div className="flex flex-col font-['Urbanist:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18191a] text-[16px] text-center tracking-[-0.4px] whitespace-nowrap">
        <p className="leading-[24px]">$55</p>
      </div>
...
function Frame3() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-center justify-center left-[1347px] px-[5px] py-[22px] rounded-[100px] size-[56px] top-[507px]">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-[-0.5px] pointer-events-none rounded-[100.5px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)]" />
      <div className="flex flex-col font-['Urbanist:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18191a] text-[16px] text-center tracking-[-0.4px] whitespace-nowrap">
        <p className="leading-[24px]">$55</p>
      </div>
...
export default function SelectWharehouseDefaultView() {
  return (
    <div className="bg-white relative size-full" data-name="Select wharehouse default view">
      <div className="absolute h-[1128.316px] left-[-140px] top-[-98px] w-[2135.935px]" data-name="image 172">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute left-[-1.26%] max-w-none size-full top-[4.17%]" src={imgImage172} />
        </div>
      </div>
      <Container />
      <Frame7 />
