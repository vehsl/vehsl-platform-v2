...
import svgPaths from "./svg-jnth74zi4f";
import { imgGroup } from "./svg-0fucl";
...
function Text16() {
  return <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[rgba(26,26,26,0.08)] left-1/2 rounded-[26843500px] size-[3px] top-1/2" data-name="Text" />;
}
...
function Container34() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] h-[152.2px] left-0 rounded-[26px] shadow-[0px_0px_8px_0px_rgba(1,113,227,0.08),0px_2px_10px_0px_rgba(1,113,227,0.04)] top-0 w-[428px]" data-name="Container">
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1px_1px_0px_rgba(255,255,255,0.7)]" />
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[19px] relative shrink-0" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex h-full items-start overflow-clip relative rounded-[inherit]">
        <p className="font-['Urbanist:Bold',sans-serif] leading-[19px] not-italic relative shrink-0 text-[#0171e3] text-[20px] tracking-[-0.2px] whitespace-nowrap">Greenstore G1</p>
      </div>
    </div>
  );
}
...
function Text37() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[24px] left-1/2 top-1/2 w-[3.862px]" data-name="Text">
      <Text38 />
    </div>
  );
}
...
function Text40() {
  return (
    <div className="absolute h-[22px] left-0 top-0 w-[30.938px]" data-name="Text">
      <p className="absolute font-['Urbanist:ExtraBold',sans-serif] leading-[22px] left-0 not-italic text-[#0171e3] text-[19px] top-[-0.8px] tracking-[-0.5px] whitespace-nowrap">$35</p>
    </div>
  );
}
...
function Text49() {
  return (
    <div className="h-[14px] relative shrink-0 w-[31.25px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Urbanist:SemiBold',sans-serif] leading-[14px] not-italic relative shrink-0 text-[11px] text-white tracking-[0.11px] whitespace-nowrap">Select</p>
      </div>
    </div>
  );
}
...
function Arrow1() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Arrow">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Arrow">
          <path d={svgPaths.p398ea600} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Container46() {
  return (
    <div className="bg-[#0171e3] h-[28.6px] relative rounded-[26843500px] shadow-[0px_1px_4px_0px_rgba(1,113,227,0.15)] shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] h-full items-center justify-center px-[14px] relative">
        <Text49 />
        <Arrow1 />
      </div>
    </div>
...
function Button6() {
  return (
    <div className="absolute h-[152.2px] left-[16px] rounded-[26px] top-[162.2px] w-[428px]" data-name="Button">
      <Container33 />
      <Container34 />
      <Container35 />
    </div>
...
function Text56() {
  return (
    <div className="-translate-y-1/2 absolute h-[24px] left-0 top-1/2 w-[3.862px]" data-name="Text">
      <Text57 />
    </div>
  );
}
...
function Button8() {
  return (
    <div className="-translate-x-1/2 absolute backdrop-blur-[2px] bg-[rgba(255,255,255,0.7)] content-stretch flex gap-[6px] h-[37.6px] items-center left-[calc(50%+0.04px)] px-[18.8px] py-[0.8px] rounded-[26843500px] top-[98.1px] w-[154.875px]" data-name="Button">
...
function Icon20() {
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g clipPath="url(#clip0_50_3652)" id="Icon">
...
function Container90() {
  return (
    <div className="bg-[rgba(255,255,255,0.55)] h-[28.6px] relative rounded-[26843500px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(1,68,136,0.08)] border-solid inset-0 pointer-events-none rounded-[26843500px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] h-full items-center px-[14.8px] py-[0.8px] relative">
        <Text100 />
        <Arrow4 />
      </div>
    </div>
...
export default function SelectStorageHoverOverAnyStorage() {
  return (
    <div className="bg-white relative size-full" data-name="Select Storage-Hover over any storage">
      <Container />
