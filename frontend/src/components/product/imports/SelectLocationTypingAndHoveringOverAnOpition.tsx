...
import svgPaths from "./svg-8f9fo1ausk";
import { imgGroup } from "./svg-sltr4";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Frame">
          <path d={svgPaths.pcefbc00} id="Vector" stroke="var(--stroke-0, #494B4D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function Frame10() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-[311.47px]">
      <Frame />
      <p className="font-['Urbanist:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#494b4d] text-[16px] w-[221px]">I</p>
    </div>
  );
}
...
function Button6() {
  return (
    <div className="bg-[rgba(26,26,26,0.06)] content-stretch flex items-center justify-center relative rounded-[26843500px] shrink-0 size-[18.166px]" data-name="Button">
      <Icon5 />
    </div>
  );
}
...
function Text24() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 size-[18.166px]" data-name="Text">
      <Icon6 />
    </div>
  );
}
...
function Separator1() {
  return <div className="h-px shrink-0 w-full" data-name="Separator" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 143, 247, 0.7) 0%, rgba(45, 132, 248, 0.7) 12.5%, rgba(90, 121, 249, 0.7) 25%, rgba(134, 110, 249, 0.7) 37.5%, rgba(179, 99, 250, 0.7) 50%, rgba(228, 75, 193, 0.7) 75%, rgba(235, 72, 131, 0.7) 87.5%, rgba(243, 69, 70, 0.7) 100%)" }} />;
}
...
function Frame11() {
  return (
    <div className="content-stretch flex font-['Urbanist:SemiBold',sans-serif] items-center justify-between leading-[1.2] not-italic relative shrink-0 text-[14px] text-white w-full whitespace-nowrap">
      <p className="relative shrink-0">Baltimore Warehouse</p>
      <p className="relative shrink-0">$170/week</p>
    </div>
  );
}
...
function MapPin() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Map pin">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Map pin">
          <g id="Icon">
            <path d={svgPaths.p35b84180} stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-[1_0_0] font-['Urbanist:Regular',sans-serif] items-center justify-between leading-[1.2] min-h-px min-w-px not-italic relative text-[12px] text-white whitespace-nowrap">
      <p className="relative shrink-0">22 miles away</p>
      <p className="relative shrink-0">{`A+ `}</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="bg-[#939699] content-stretch flex flex-col gap-[4px] h-[51px] items-start justify-center px-[16px] py-[8px] relative rounded-[12px] shrink-0 w-[400px]">
      <Frame11 />
      <Frame13 />
    </div>
  );
...
function Frame3() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between leading-[1.2] not-italic px-[16px] py-[8px] relative text-[#18191a] w-full whitespace-nowrap">
          <p className="font-['Urbanist:Medium',sans-serif] relative shrink-0 text-[14px]">Frederick Warehouse</p>
          <p className="font-['Urbanist:Regular',sans-serif] relative shrink-0 text-[12px]">$95/week</p>
        </div>
      </div>
    </div>
  );
...
function Frame4() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between leading-[1.2] not-italic px-[16px] py-[8px] relative text-[#18191a] w-full whitespace-nowrap">
          <p className="font-['Urbanist:Medium',sans-serif] relative shrink-0 text-[14px]">Greenfield Storage</p>
          <p className="font-['Urbanist:Regular',sans-serif] relative shrink-0 text-[12px]">$80/week</p>
        </div>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between leading-[1.2] not-italic px-[16px] py-[8px] relative text-[#18191a] w-full whitespace-nowrap">
          <p className="font-['Urbanist:Medium',sans-serif] relative shrink-0 text-[14px]">Maplewood Depot</p>
          <p className="font-['Urbanist:Regular',sans-serif] relative shrink-0 text-[12px]">$70/week</p>
        </div>
      </div>
    </div>
  );
...
function Frame6() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between leading-[1.2] not-italic px-[16px] py-[8px] relative text-[#18191a] w-full whitespace-nowrap">
          <p className="font-['Urbanist:Medium',sans-serif] relative shrink-0 text-[14px]">Pinecrest Warehouse</p>
          <p className="font-['Urbanist:Regular',sans-serif] relative shrink-0 text-[12px]">$120/week</p>
        </div>
      </div>
    </div>
  );
...
function Frame7() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between leading-[1.2] not-italic px-[16px] py-[8px] relative text-[#18191a] w-full whitespace-nowrap">
          <p className="font-['Urbanist:Medium',sans-serif] relative shrink-0 text-[14px]">Oak Valley Storage</p>
          <p className="font-['Urbanist:Regular',sans-serif] relative shrink-0 text-[12px]">$110/week</p>
        </div>
      </div>
    </div>
  );
...
function Frame8() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between leading-[1.2] not-italic px-[16px] py-[8px] relative text-[#18191a] w-full whitespace-nowrap">
          <p className="font-['Urbanist:Medium',sans-serif] relative shrink-0 text-[14px]">Cypress Distribution</p>
          <p className="font-['Urbanist:Regular',sans-serif] relative shrink-0 text-[12px]">$85/week</p>
        </div>
      </div>
    </div>
  );
...
function Frame9() {
  return (
    <div className="relative rounded-bl-[30px] rounded-br-[30px] rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between leading-[1.2] not-italic px-[16px] py-[8px] relative text-[#18191a] w-full whitespace-nowrap">
          <p className="font-['Urbanist:Medium',sans-serif] relative shrink-0 text-[14px]">Birchwood Facility</p>
          <p className="font-['Urbanist:Regular',sans-serif] relative shrink-0 text-[12px]">$90/week</p>
        </div>
      </div>
    </div>
  );
...
function DropDownMenuMainBodyTrending() {
  return (
    <div className="backdrop-blur-[4px] relative rounded-bl-[30px] rounded-br-[30px] rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="drop down menu main body-trending">
      <div className="content-stretch flex flex-col gap-[6px] items-start px-[8px] relative w-full">
        <Frame3 />
        <Frame4 />
        <Frame5 />
        <Frame6 />
...
function MenuItems() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Menu Items">
      <Separator />
      <Frame2 />
      <DropDownMenuMainBodyTrending />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.2)] content-stretch flex flex-col items-start left-[22.1px] overflow-clip py-[10px] rounded-[40px] shadow-[0px_4px_8px_0px_rgba(0,0,0,0.1)] top-[180.79px] w-[415.8px]">
      <Frame1 />
      <MenuItems />
    </div>
  );
...
export default function SelectLocationTypingAndHoveringOverAnOpition() {
  return (
    <div className="relative size-full" data-name="Select location-typing and hovering over an opition">
      <Container />
      <PK />
    </div>
  );
