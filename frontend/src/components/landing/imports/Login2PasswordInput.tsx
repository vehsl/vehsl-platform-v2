...
import svgPaths from "./svg-y885y7p9do";
...
function Group1() {
  return (
    <div className="absolute inset-[8.34%_16.66%_8.34%_16.67%]">
      <div className="absolute inset-[-4.5%_-5.63%_-4.51%_-5.62%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.7143 15.5714">
          <g id="Group 314">
            <path d={svgPaths.pfe49b00} id="Vector" stroke="var(--stroke-0, #0D1117)" strokeWidth="1.28571" />
            <path d={svgPaths.p34568c00} id="Vector_2" stroke="var(--stroke-0, #0D1117)" strokeLinecap="round" strokeWidth="1.28571" />
            <path d={svgPaths.p271c7a20} id="Vector_3" stroke="var(--stroke-0, #0D1117)" strokeLinecap="round" strokeWidth="1.28571" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="absolute inset-[11.46%]" data-name="Image">
      <div className="absolute inset-[-4.42%_-4.42%_-4.43%_-4.42%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.8214 15.8214">
          <g id="Image">
            <path d={svgPaths.p884ca00} id="Stroke 1" stroke="var(--stroke-0, #56585D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.28571" />
...
function Frame18() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col items-start left-[calc(45.83%+54px)] top-[147.43px] w-[498.857px]">
      <Frame11 />
    </div>
  );
}
      ...
      <div className="relative shrink-0 size-[37.714px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.7143 37.7143">
          <g id="Ellipse 60">
            ...
            <circle cx="18.8571" cy="18.8571" r="18.4286" stroke="url(#paint0_linear_6_1294)" strokeOpacity="0.7" strokeWidth="0.857143" />
            <circle cx="18.8571" cy="18.8571" r="18.4286" stroke="url(#paint1_radial_6_1294)" strokeOpacity="0.05" strokeWidth="0.857143" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_1294" x1="0" x2="37.7143" y1="18.8571" y2="18.8571">
            ...
            <radialGradient cx="0" cy="0" gradientTransform="matrix(50.7752 -36.9203 5.14775 46.702 12.3653 25.209)" gradientUnits="userSpaceOnUse" id="paint1_radial_6_1294" r="1">
...
function Shadow() {
  return <div className="absolute inset-[-22.29px]" data-name="Shadow" />;
}

function GlassEffect2() {
  return <div className="absolute bg-[rgba(0,0,0,0)] blur-[0.073px] border-[#0894ff] border-[1.469px] border-solid inset-0 rounded-[20.571px]" data-name="Glass Effect" />;
}

function Group4() {
  return (
    <div className="absolute h-[17.143px] left-[47.94%] right-[47.89%] top-[236.57px]">
      <div className="absolute inset-[-2.14%_-2.35%_-2.86%_-1.76%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.6744 18">
          <g id="Group 2213">
            <path d={svgPaths.p374ef300} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.734693" />
            <path d={svgPaths.p332f61c} id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.979591" />
            <path d={svgPaths.p39e8a380} id="Vector_3" stroke="url(#paint0_linear_6_1257)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.734693" />
            <path d={svgPaths.p28512d00} id="Vector_4" stroke="url(#paint1_linear_6_1257)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.489796" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_1257" x1="0.356608" x2="8.80927" y1="0.466246" y2="1.38463">
              <stop stopColor="#0894FF" />
              <stop offset="0.34" stopColor="#C959DD" />
              <stop offset="0.68" stopColor="#FF2E54" />
              <stop offset="1" stopColor="#FF9004" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_6_1257" x1="2.81234" x2="6.13437" y1="2.85541" y2="3.21635">
              <stop stopColor="#0894FF" />
              <stop offset="0.34" stopColor="#C959DD" />
              <stop offset="0.68" stopColor="#FF2E54" />
              <stop offset="1" stopColor="#FF9004" />
...
function GlassEffect3() {
  return <div className="absolute bg-[rgba(255,255,255,0.07)] border-[#0171e3] border-[1.286px] border-solid inset-0 mix-blend-screen rounded-[20.571px]" data-name="Glass Effect" />;
}

function Frame17() {
  return (
    <div className="absolute h-[34.286px] left-[393.57px] top-[172.29px] w-[53.143px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 53.1429 34.2857">
        <g id="Frame 1000012595">
          <rect fill="var(--fill-0, #0171E3)" height="34.2857" rx="17.1429" width="53.1429" />
          <path d={svgPaths.p3dc3500} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function GlassEffect4() {
  return <div className="absolute bg-[rgba(255,255,255,0.07)] inset-0 mix-blend-screen rounded-[20.571px]" data-name="Glass Effect" />;
}

function Frame20() {
  return (
    <div className="absolute backdrop-blur-[10.286px] bg-[rgba(255,255,255,0.1)] content-stretch flex flex-col gap-[8.571px] h-[298.286px] items-start left-[calc(58.33%+45.43px)] p-[17.143px] rounded-[25.714px] top-[55.71px] w-[498.857px]">
      <div aria-hidden="true" className="absolute border-[#00d0ff] border-[0.857px] border-solid inset-0 pointer-events-none rounded-[25.714px] shadow-[0px_3.429px_20.571px_0px_rgba(0,0,0,0.06)]" />
      <div className="absolute inset-[229.71px_196.29px_25.71px_196.29px]" data-name="Clear Glass">
        <Shadow />
        <GlassEffect2 />
      </div>
      <Group4 />
      <div className="absolute inset-[168px_48px_87.43px_48px]" data-name="Clear Glass">
        <Shadow1 />
        <GlassEffect3 />
      </div>
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] h-[17.143px] leading-[14.571px] left-[66px] not-italic text-[17.143px] text-black top-[187.71px] w-[355.714px]">Abcd123</p>
      <Frame17 />
      <div className="absolute inset-[114px_48px_141.43px_48px]" data-name="Clear Glass">
        <Shadow2 />
        <GlassEffect4 />
      </div>
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] h-[19.714px] leading-[14.571px] left-[66.86px] not-italic text-[#86868b] text-[11.143px] top-[173.14px] w-[48.857px]">Password</p>
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] h-[11.143px] leading-[14.571px] left-[66.86px] not-italic text-[#86868b] text-[10.286px] top-[119.14px] w-[118.286px]">Email or Phone Number</p>
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] h-[17.143px] leading-[14.571px] left-[66px] not-italic text-[17.143px] text-black top-[133.71px] w-[355.714px]">abcd@gmial.com</p>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_1.714px_17.143px_0px_white]" />
    </div>
  );
}

export default function Login2PasswordInput() {
  return (
    <div className="relative size-full" data-name="Login 2-password input" style={{ backgroundImage: "linear-gradient(160.167deg, rgb(209, 230, 247) 21.897%, rgb(228, 239, 254) 46.759%, rgb(246, 251, 249) 70.561%)" }}>
      <Frame18 />
      ...
      <Frame20 />
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] leading-[1.2] left-[calc(75%-15.43px)] not-italic text-[#19202b] text-[20.571px] top-[85.71px] whitespace-nowrap" dir="auto">{`Login or Sign up `}</p>
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] leading-[1.2] left-[calc(83.33%-87.43px)] not-italic text-[#86868b] text-[13.714px] top-[308.57px] whitespace-nowrap" dir="auto">
        Sign Up
      </p>
    </div>
  );
