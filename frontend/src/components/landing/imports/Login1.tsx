...
import svgPaths from "./svg-h0aey80z0p";
...
function Group1() {
  return (
    <div className="absolute inset-[8.33%_16.66%_8.34%_16.67%]">
      <div className="absolute inset-[-4.5%_-5.62%_-4.51%_-5.63%]">
      ...
      <div className="relative shrink-0 size-[37.714px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.7143 37.7143">
          <g id="Ellipse 60">
            ...
            <circle cx="18.8571" cy="18.8571" r="18.4286" stroke="url(#paint0_linear_6_1175)" strokeOpacity="0.7" strokeWidth="0.857143" />
            <circle cx="18.8571" cy="18.8571" r="18.4286" stroke="url(#paint1_radial_6_1175)" strokeOpacity="0.05" strokeWidth="0.857143" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_1175" x1="0" x2="37.7143" y1="18.8571" y2="18.8571">
            ...
            <radialGradient cx="0" cy="0" gradientTransform="matrix(50.7752 -36.9203 5.14775 46.702 12.3653 25.209)" gradientUnits="userSpaceOnUse" id="paint1_radial_6_1175" r="1">
...
function GlassEffect2() {
  return <div className="absolute bg-[rgba(255,255,255,0.07)] border-[#86868b] border-[0.857px] border-solid inset-0 mix-blend-screen rounded-[20.571px]" data-name="Glass Effect" />;
}
...
function Frame20() {
  return (
    <div className="absolute backdrop-blur-[10.286px] bg-[rgba(255,255,255,0.1)] content-stretch flex flex-col gap-[8.571px] h-[298.286px] items-start left-[calc(58.33%+45.43px)] p-[17.143px] rounded-[25.714px] top-[55.71px] w-[498.857px]">
      ...
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] h-[11px] leading-[14.571px] left-[66.57px] not-italic text-[#86868b] text-[10.286px] top-[119.29px] w-[192px]">Email/Phone Number (existing or new)</p>
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] h-[17.143px] leading-[14.571px] left-[66px] not-italic text-[17.143px] text-black top-[132px] w-[355.714px]">I</p>
...
function Group4() {
  return (
    <div className="absolute contents left-[calc(75%+2px)] top-[285px]">
      <div className="absolute inset-[285px_calc(8.33%+131.71px)_300.14px_calc(75%+2px)]" data-name="Clear Glass">
        <Shadow2 />
        <GlassEffect4 />
      </div>
...
export default function Login() {
  return (
    <div className="relative size-full" data-name="Login 1" style={{ backgroundImage: "linear-gradient(160.167deg, rgb(209, 230, 247) 21.897%, rgb(228, 239, 254) 46.759%, rgb(246, 251, 249) 70.561%)" }}>
      <Frame18 />
