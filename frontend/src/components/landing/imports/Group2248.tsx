...
import svgPaths from "./svg-q8dsnuyboa";
...
function Frame() {
  return (
    <div className="absolute bg-[#86868b] content-stretch flex h-[32px] items-center justify-center left-[344px] p-[10.286px] rounded-[42.857px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] top-[250px] w-[50px]">
      <Group2 />
    </div>
  );
}
...
function GlassEffect() {
  return (
    <div className="absolute inset-[65px_0_167px_0] rounded-[20px]" data-name="Glass Effect">
...
function GlassEffect1() {
  return (
    <div className="absolute inset-[129px_0_103px_0] rounded-[20px]" data-name="Glass Effect">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0.07)] inset-0 mix-blend-screen pointer-events-none rounded-[20px]" />
      <div className="overflow-clip relative rounded-[inherit] size-full">
...
function Group4() {
  return (
    <div className="absolute contents inset-[65px_0_103px_0]">
      <GlassEffect />
      <GlassEffect1 />
    </div>
  );
...
function GlassEffect2() {
  return (
    <div className="absolute inset-[193px_0_39px_0] rounded-[20px]" data-name="Glass Effect">
      <div aria-hidden="true" className="absolute bg-[rgba(255,255,255,0.07)] inset-0 mix-blend-screen pointer-events-none rounded-[20px]" />
      <div className="overflow-clip relative rounded-[inherit] size-full">
...
function Group5() {
  return (
    <div className="absolute contents inset-[65px_0_39px_0]">
      <Group4 />
      <GlassEffect2 />
    </div>
  );
