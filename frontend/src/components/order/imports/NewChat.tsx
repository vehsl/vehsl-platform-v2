...
import svgPaths from "./svg-pj60pi0cxw";
...
function Span() {
  return (
    <div className="absolute bg-[rgba(232,232,237,0.6)] content-stretch flex h-[26.4px] items-start left-[327.84px] px-[16px] py-[6px] rounded-[26843500px] top-[24.4px] w-[64.325px]" data-name="span">
      <p className="font-['Urbanist:Medium',sans-serif] leading-[17.28px] not-italic relative shrink-0 text-[#86868b] text-[11.52px] text-center">Today</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[15.6px] relative shrink-0 w-[7.763px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Urbanist:Bold',sans-serif] leading-[15.6px] left-0 not-italic text-[10.4px] text-white top-[0.6px]">V</p>
      </div>
    </div>
  );
}
...
function P() {
  return (
    <div className="h-[45.875px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Urbanist:Regular',sans-serif] leading-[22.94px] left-0 not-italic text-[#1d1d1f] text-[14.8px] top-[-1.4px] tracking-[-0.074px] w-[387px] whitespace-pre-wrap">{`Hi there! I'm from the Vehsl support team. How can I help you today?`}</p>
    </div>
  );
}
...
function P1() {
  return (
    <div className="h-[16.313px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Urbanist:Regular',sans-serif] leading-[16.32px] left-[8px] not-italic text-[#c7c7cc] text-[10.88px] top-[-0.4px]">4:49 PM</p>
    </div>
  );
}
...
function Div2() {
  return (
    <div className="absolute bg-white border-[#e8e8ed] border-[0.8px] border-solid h-[45.6px] left-0 rounded-[26843500px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.02)] top-0 w-[177.938px]" data-name="div">
      <p className="-translate-x-1/2 absolute font-['Urbanist:Medium',sans-serif] leading-[19.68px] left-[88.5px] not-italic text-[#0071e3] text-[13.12px] text-center top-[11.8px]">I need help with an order</p>
    </div>
  );
}
...
function Div3() {
  return (
    <div className="absolute bg-white border-[#e8e8ed] border-[0.8px] border-solid h-[45.6px] left-0 rounded-[26843500px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.02)] top-0 w-[182.863px]" data-name="div">
      <p className="-translate-x-1/2 absolute font-['Urbanist:Medium',sans-serif] leading-[19.68px] left-[91px] not-italic text-[#0071e3] text-[13.12px] text-center top-[11.8px]">I have a shipping question</p>
    </div>
  );
}
...
function Div4() {
  return (
    <div className="absolute bg-white border-[#e8e8ed] border-[0.8px] border-solid h-[45.6px] left-0 rounded-[26843500px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.02)] top-0 w-[181.813px]" data-name="div">
      <p className="-translate-x-1/2 absolute font-['Urbanist:Medium',sans-serif] leading-[19.68px] left-[90.5px] not-italic text-[#0071e3] text-[13.12px] text-center top-[11.8px]">I want to return a product</p>
    </div>
  );
}
...
function Div5() {
  return (
    <div className="absolute bg-white border-[#e8e8ed] border-[0.8px] border-solid h-[45.6px] left-0 rounded-[26843500px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.02)] top-0 w-[135.813px]" data-name="div">
      <p className="-translate-x-1/2 absolute font-['Urbanist:Medium',sans-serif] leading-[19.68px] left-[67.5px] not-italic text-[#0071e3] text-[13.12px] text-center top-[11.8px]">I need help selling</p>
    </div>
  );
}
...
function Div6() {
  return (
    <div className="absolute bg-white border-[#e8e8ed] border-[0.8px] border-solid h-[45.6px] left-0 rounded-[26843500px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.02)] top-0 w-[122.55px]" data-name="div">
      <p className="-translate-x-1/2 absolute font-['Urbanist:Medium',sans-serif] leading-[19.68px] left-[60.5px] not-italic text-[#0071e3] text-[13.12px] text-center top-[11.8px]">Something else</p>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] h-[38.8px] min-h-px min-w-px relative" data-name="input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip py-[8px] relative rounded-[inherit] size-full">
        <p className="font-['Urbanist:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c7c7cc] text-[15.2px] tracking-[-0.152px]">Type a message...</p>
      </div>
    </div>
  );
}
...
function Smile() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Smile">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g clipPath="url(#clip0_352_3972)" id="Smile">
...
function Send() {
  return (
    <div className="relative shrink-0 size-[15.2px]" data-name="Send">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.2 15.2">
        <g id="Send">
          <path d={svgPaths.p17672900} id="Vector" stroke="var(--stroke-0, #C7C7CC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.26667" />
          <path d={svgPaths.p108c4700} id="Vector_2" stroke="var(--stroke-0, #C7C7CC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.26667" />
        </g>
      </svg>
    </div>
  );
...
function MotionDiv3() {
  return (
    <div className="bg-[#e8e8ed] h-[34.2px] relative rounded-[26843500px] shrink-0 w-full" data-name="motion.div">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center relative size-full">
          <Send />
        </div>
...
function MotionButton7() {
  return (
    <div className="relative shrink-0 size-[36px]" data-name="motion.button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[0.9px] px-[0.9px] relative size-full">
        <MotionDiv3 />
      </div>
    </div>
  );
...
function P2() {
  return (
    <div className="h-[16.313px] relative shrink-0 w-full" data-name="p">
      <p className="-translate-x-1/2 absolute font-['Urbanist:Regular',sans-serif] leading-[16.32px] left-[360.49px] not-italic text-[#c7c7cc] text-[10.88px] text-center top-[-0.4px]">Vehsl support team typically responds within 2 minutes</p>
    </div>
  );
}
...
function Span2() {
  return (
    <div className="h-[19.2px] relative shrink-0 w-[9.55px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Urbanist:Bold',sans-serif] leading-[19.2px] left-0 not-italic text-[12.8px] text-white top-[-0.4px]">V</p>
      </div>
    </div>
  );
}
...
function P3() {
  return (
    <div className="content-stretch flex h-[19.238px] items-start overflow-clip relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Urbanist:SemiBold',sans-serif] leading-[19.24px] min-h-px min-w-px not-italic relative text-[#1d1d1f] text-[14.8px] whitespace-pre-wrap">Vehsl Support</p>
    </div>
  );
}
...
function P4() {
  return (
    <div className="flex-[1_0_0] h-[17.288px] min-h-px min-w-px relative" data-name="p">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Urbanist:Regular',sans-serif] leading-[17.28px] left-0 not-italic text-[#86868b] text-[11.52px] top-[-1.2px]">Usually replies in 2 minutes</p>
      </div>
    </div>
  );
}
...
export default function NewChat() {
  return (
    <div className="bg-white relative size-full" data-name="new chat">
      <MotionDiv />
      <Div7 />
      <Div10 />
    </div>
