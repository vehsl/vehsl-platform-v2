...
import svgPaths from "./svg-aszl2s88me";
  ...
  return (
    <div className="absolute left-0 size-[100.001px] top-0">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 100.001 100.001">
        <g id="Group 2444">
          <g clipPath="url(#paint0_angular_272_7270_clip_path)" data-figma-skip-parse="true">
        ...
        <defs>
          <clipPath id="paint0_angular_272_7270_clip_path">
