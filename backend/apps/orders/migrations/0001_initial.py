...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name="review",
            constraint=models.CheckConstraint(check=(models.Q(target_product__isnull=True, target_seller__isnull=False, target_type="seller") | models.Q(target_product__isnull=False, target_seller__isnull=True, target_type="product")), name="review_target_exactly_one"),
        ),
    ]
